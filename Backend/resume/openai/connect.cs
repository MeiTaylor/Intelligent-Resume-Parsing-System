        ...
        */
        ...
        private static void getFile(string directoryPath, string fileName, string extension, int n)
        {
            try
            {
                ...
                start.FileName = @"E:\anaconda\envs\open\python.exe";
                start.Arguments = string.Format("{0} \"{1}\" {2} \" {3} \" {4} \" {5}", @"E:\SCB_Backend\end\fileRelate.py", directoryPath, fileName, extension, n, key);
        ...
        private static async Task<Dictionary<string, object>> Run1(string filepath)
        {
            ...
            string key = "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";
            ...
            string schoolRanksFilePath = @"E:\SCB_Backend\end\school.json";
        ...
        private static async Task<Dictionary<string, object>> Run2(string filepath)
        {
            ...
            string key = "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";
        ...
        private static Task<string> RunPythonScript(string filepath, string fileName, string extension, int n, int maxTries, string key)
        {
            ...
            try
            {
                ProcessStartInfo start = new ProcessStartInfo();
                start.FileName = @"E:\anaconda\envs\open\python.exe";
                start.Arguments = string.Format("{0} \"{1}\" {2} \" {3} \" {4} \" {5}", @"E:\SCB_Backend\end\chat.py", filepath, fileName, extension, n, key);
