...
namespace resume.Services
{
    public class CompanyService
    {
        ...
        public CompanyService(IPasswordHasher<User> passwordHasher, MyDbContext dbContext)
        {
        ...
        public RegisterModelClass CreateNewAccount(RegisterSentModel register)
        {
            ...
            else
            {
                ...
                // 使用该实例生成哈希密码
                var hashedPassword = _passwordHasher.HashPassword(user, register.Password);
        ...
        public CreateUserResultClass CreateUserByClass(CreateUserSentClass NewUserInfo)
        {
            ...
            // 使用该实例生成哈希密码
            var hashedPassword = _passwordHasher.HashPassword(user, NewUserInfo.Password);
